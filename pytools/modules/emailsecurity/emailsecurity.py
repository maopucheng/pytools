...
class EmailSecurity:
    ...
    def __init__(
        self, emails=None, check_mode='Haveibeenpwned', hibp_api_key=None, **kwargs
    ):
        assert check_mode in ['Firefox', 'Haveibeenpwned']
        if hibp_api_key is None:
            hibp_api_key = random.choice(
                [
                    'e0c4c2b5c7304030912b2251e15d7dac',
                    '398bba8c95cc4db4a23138af3037a496',
                    'f269230d7044457a910dc8d2d1205013',
                ]
            )
        if emails is None:
            emails = [
                ...
                'hubeiyangyi@163.com',
                'h465932675@163.com',
                'xiajiahao456@163.com',
                'zhangaorui1@163.com',
                'babby126@163.com',
                'a794685816@163.com',
                'zzw67090@163.com',
                'maye915@163.com',
                'mao164951618@163.com',
                'mczhoulei2011@163.com',
            ]
        self.emails = emails
    ...
    def checkFirefox(self, emails):
        print(
            '[INFO]: Using https://monitor.firefox.com/ to verify the security of your email...'
        )
        ...
        for idx, email in enumerate(emails):
            ...
            if int(re.findall(r'此电子邮件地址出现在(.*?)次已知数据外泄事件中', info)[0]) > 0:
                info += html.xpath(
                    'string(/html/body/main/div[2]/div[1]/a/div[2]/div[1])'
                )
    ...
    def checkHaveibeenpwned(self, emails):
        print(
            '[INFO]: Using https://haveibeenpwned.com/ to verify the security of your email...'
        )
        ...
        for idx, email in enumerate(emails):
            ...
            if response.status_code == 200:
                ...
                for leak in response.json():
                    info = session.get(
                        f'https://haveibeenpwned.com/api/v3/breach/{leak["Name"]}'
                    ).json()
